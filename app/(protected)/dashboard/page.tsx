...
export default function DashboardPage() {
  ...
  // Check if user has home_liaison role (or always show for testing)
  const isHomeLiaison = permissions.hasRole("home_liaison", "home-visits") || true // Always show for testing
  ...
  useEffect(() => {
    ...
    if (permissions.isLoaded || true) { // Always load for testing
      if (isHomeLiaison) {
  ...
  // Show Home Liaison dashboard (always for testing)
  if (isHomeLiaison) {
    if (liaisonLoading) {
      return (
