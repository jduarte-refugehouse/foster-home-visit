...
import { RepositoryBrowser } from "@/components/admin/repository-browser"
...
export default function RepositoryPage() {
  ...
  if (!githubConfig) {
    return (
      <div className="flex flex-col gap-6 p-6">
        <div>
          <h1 className="text-3xl font-bold">Repository Browser</h1>
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div>
        <h1 className="text-3xl font-bold">Repository Browser</h1>
        <p className="text-muted-foreground mt-2">
          Browse and view files from <code className="bg-muted px-1 py-0.5 rounded">{githubConfig.owner}/{githubConfig.repo}</code>
        </p>
      </div>
      <RepositoryBrowser owner={githubConfig.owner} repo={githubConfig.repo} />
    </div>
  )
}
